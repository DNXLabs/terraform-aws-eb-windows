...
resource "aws_elastic_beanstalk_environment" "env" {
  ...
  solution_stack_name    = var.solutions_stack_name_regex && data.aws_elastic_beanstalk_solution_stack.solution_stack[0] ? data.aws_elastic_beanstalk_solution_stack.solution_stack[0] : var.eb_solution_stack_name
